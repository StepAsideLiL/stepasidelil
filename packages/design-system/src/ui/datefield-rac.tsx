...
const dateInputStyle = cn(
  "relative inline-flex h-9 w-full items-center overflow-hidden whitespace-nowrap rounded-md border border-transparent bg-background px-3 py-2 text-sm transition-[color,box-shadow] outline-none data-focus-within:border-transparent data-focus-within:ring-transparent data-focus-within:ring-[3px] data-focus-within:has-aria-invalid:ring-destructive/20 dark:data-focus-within:has-aria-invalid:ring-destructive/40 data-focus-within:has-aria-invalid:border-destructive"
);
